...
if __name__ == "__main__":
    ...
    # Train model
    model = train_linear_regression(prepared_data['X_train_scaled'], prepared_data['y_train'])
    
    # Evaluate model
    train_score = model.score(prepared_data['X_train_scaled'], prepared_data['y_train'])
    test_score = model.score(prepared_data['X_test_scaled'], prepared_data['y_test'])
